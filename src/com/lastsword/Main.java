...
public class Main {
    public static void main(String[] args) {
        //new Game();
        try {
            BufferedImage spriteSheet = ImageIO.read(new File("src/res/images/sprites/player/samurai_archer/Attack_1.png")); // Завантаження спрайт-аркуша
            ...
            // Далі можна використовувати отримані кадри
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
